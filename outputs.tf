...
output "id" {
  description = "The Terraform resource ID of the security group egress rule."
...
output "security_group_id" {
  description = "The ID of the security group to which this egress rule is attached."
  value       = aws_vpc_security_group_egress_rule.this.security_group_id
}

output "egress_rule_effective_source" {
  description = "A canonical string describing the effective destination for this egress rule (CIDR, prefix list, or security group)."
