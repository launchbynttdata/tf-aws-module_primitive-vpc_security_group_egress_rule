...
This example provides a basic test case for the `tf-aws-module_primitive-vpc_security_group_egress_rule` module, used primarily for integration testing.

## Features

- Single SSH egress rule (port 22)
...
| <a name="input_resource_name_prefix"></a> [resource\_name\_prefix](#input\_resource\_name\_prefix) | Prefix for resource names | `string` | `"sger-simple"` | no |
