...
This example demonstrates using security groups as sources for egress rules with the `tf-aws-module_primitive-vpc_security_group_egress_rule` module.
...
- 2 Security Group Egress Rules (PostgreSQL and MySQL)
...
- Rules: Allow to application tier only
...
|------|-------------|------|---------|:--------:|
| <a name="input_resource_name_prefix"></a> [resource\_name\_prefix](#input\_resource\_name\_prefix) | Prefix for resource names | `string` | `"sger-sg-to-sg"` | no |
