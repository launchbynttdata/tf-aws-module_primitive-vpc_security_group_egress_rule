...
variable "security_group_id" {
  description = "The ID of the security group to which this egress rule will be attached."
  type        = string
...
variable "cidr_ipv4" {
  description = "The destination IPv4 CIDR range for this egress rule. Mutually exclusive with cidr_ipv6, prefix_list_id, and referenced_security_group_id."
  type        = string
  default     = null
...
variable "cidr_ipv6" {
  description = "The destination IPv6 CIDR range for this egress rule. Mutually exclusive with cidr_ipv4, prefix_list_id, and referenced_security_group_id."
  type        = string
  default     = null
...
variable "prefix_list_id" {
  description = "The ID of the prefix list for the destination of this egress rule. Mutually exclusive with cidr_ipv4, cidr_ipv6, and referenced_security_group_id."
  type        = string
  default     = null
...
variable "referenced_security_group_id" {
  description = "The ID of the destination security group for this egress rule. Mutually exclusive with cidr_ipv4, cidr_ipv6, and prefix_list_id."
  type        = string
  default     = null
...
variable "description" {
  description = "The description of this egress rule."
  type        = string
  default     = null
...
variable "tags" {
  description = "A map of tags to assign to the egress rule."
  type        = map(string)
  default     = {}
}
